...
int main()
{
    ...
    char second_word, second_word_text[] = "System Programming practice";
    char third_word, third_word_text[] = "Nothing without you";
